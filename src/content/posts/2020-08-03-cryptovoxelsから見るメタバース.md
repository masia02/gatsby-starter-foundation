...
**Decentraland**はユーザーが所有する仮想世界でもあり、ブロックチェーンに仮想世界を配置するという考えを持った最初のプロジェクトでした。しかし、クリプトボクセルとは対照的に、デセントラランドは今はやっとPCでのみログインできます。2017年8月、DecentralandはICOを通じて2,400万ドルを調達しました。CryptovoxelsはICOを行ったことはありませんが、開発者がさらに資金を必要とするときはいつでも、デジタル土地の区画を販売することで資金を調達しています。
